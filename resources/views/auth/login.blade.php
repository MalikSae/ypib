...
<div class="auth-card">
    ...
    <h1 style="font-size:22px;font-weight:700;color:#0A1317;margin:0 0 4px 0;">Masuk ke Akun</h1>
    <p style="font-size:14px;color:#5D6C7B;margin:0 0 28px 0;">Selamat datang kembali di PMB YPIB Majalengka</p>
    ...
    <p style="text-align:center;font-size:14px;color:#5D6C7B;margin:0;">
        Belum punya akun?
