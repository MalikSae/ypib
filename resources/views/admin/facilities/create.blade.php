...
<div class="max-w-4xl">
    ...
    <div class="flex flex-col md:flex-row md:items-center gap-3 mb-6">
        ...
        <div>
            <h1 class="text-2xl font-bold text-neutral-900 mb-1">Tambah Fasilitas</h1>
            <p class="text-sm text-neutral-500">Masukkan data fasilitas baru</p>
        </div>
    </div>

    <x-card class="p-6 md:p-8">
        <form action="{{ route('admin.facilities.store') }}" method="POST" x-data="{ submitting: false }" @submit="submitting = true">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div class="md:col-span-2 lg:col-span-1">
                    ...
                    <x-text-input type="text" id="name" name="name" :value="old('name')" required :error="$errors->has('name')" />
                ...
                <div class="md:col-span-2 lg:col-span-1">
                    ...
                    <x-text-input type="text" id="icon" name="icon" :value="old('icon')" placeholder="Contoh: ti-flask" :error="$errors->has('icon')" />
            ...
            <div class="flex justify-end gap-3 pt-6 border-t border-neutral-200">
                ...
                <x-button type="submit" color="primary" ::disabled="submitting">
                    <span x-show="!submitting">Simpan Fasilitas</span>
